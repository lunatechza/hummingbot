...
class TestChainEXExchange(unittest.TestCase):
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.chainex.chainex_exchange.ChainEXExchange.get_price")
    ...
    @patch("hummingbot.connector.exchange.chainex.chainex_exchange.ChainEXExchange._sleep")
